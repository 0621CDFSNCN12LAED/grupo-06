...
const storage = multer.diskStorage({
    ...
    filename: (req, file, cb) => {
        const nombreEstudioImagen = Date.now() + '_estudio' + path.extname(file.originalname);
...
router.post("/crear-estudio", upload.single('imagenEstudio'), estudiosController.guardarEstudio);
